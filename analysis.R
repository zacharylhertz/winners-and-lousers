...
library(data.table)   # Fast data readings
...
# Load Census Data ----------------------------------------------------------
# Note that I (obviously) cannot add a 6gb dataset to Github. 
# This is the code I used to process the full block-level data.
...
# As you might know, you cannot host large files on Github.
# Instead, I wrote it to the (much smaller) .csv that is included in this repo.
# write.csv(census, "data/sfcensus_data.csv", row.names=FALSE)

census <- read.csv("data/sfcensus_data.csv")
